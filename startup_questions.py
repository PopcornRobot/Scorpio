...
q = Question.objects.bulk_create([
    ...
    Question(text="<strong>I watch TV.</strong> I watch 3+ hours of TV/Netflix a week.",
    ...
    Question(text="<strong>I like to cook.</strong> I enjoy cooking.",
    ...
    Question(text="<strong>I broke a bone.</strong> I've broken a bone in my life.",
    ...
    Question(text="<strong>I'm a workaholic.</strong> I've worked over 12 hours a day or have worked over 60 hours a week.",
    ...
    Question(text="<strong>I eat food on the ground.</strong> I am not afraid to eat food that fell on the ground.",
    ...
    Question(text="<strong>I have thrownup when drunk.</strong> I've gotten so drunk, that i threw up.",
    ...
    Question(text="<strong>I lied on this survey.</strong>",
